const weddingParty = [
  ...
  },
  {
    name: "Bea Tongco",
    source: "/imgs/bea.jpg",
    description: `Victoria and I first met at the “Vic One: Ryerson
  ...
  },
  {
    ...
    description: `My Vick ❤️ Where do I even begin? From the moment The
  ...
  },
  {
    name: "Ted Nijimbere",
    source: "/imgs/ted.jpg",
    description: `I met Kelub in my first year of University and he is one
  ...
  {
    name: "Braeden Chang",
    source: "/imgs/braeden.jpg",
    description: `I’ve known Kelub since second year of University & have
  ...
  {
    name: "Mohian Rahman",
    source: "/imgs/mohian.jpg",
    description: `I met Kelub in the early years of our undergrad through
  ...
  {
    name: "Dushawn Francis",
    source: "/imgs/dushawn.jpg",
    description: `First things first, I wan’t to say CONGRATULATIONS to
  ...
  },
  {
    ...
    source: "/imgs/daniel.jpg",
    description: `Hi my name is Daniel one of Kelub&apos;s best friends.
  ...
  {
    name: "Philip George",
    source: "/imgs/phil.jpg",
    description: `So I was thinking about what story I could use that
  ...
  {
    name: "Brian Richmond",
    source: "/imgs/brian.jpg",
    description: `I knew Kelub since we were kids! The one story I can
